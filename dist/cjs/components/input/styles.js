...
const styles = props => _reactNative.StyleSheet.create({
  ...
  wrapprerIcon: {
    width: 56,
    height: props !== null && props !== void 0 && props.heightWrapperIcon ? props === null || props === void 0 ? void 0 : props.heightWrapperIcon : 50,
    backgroundColor: "transparent",
    alignItems: "center",
  ...
  wrapprerIconExpiressAndCode: {
    width: 56,
    height: (props === null || props === void 0 ? void 0 : props.heightWrapperIcon) ?? 50,
    backgroundColor: "transparent",
    alignItems: "center",
    justifyContent: "center",
    position: "absolute",
